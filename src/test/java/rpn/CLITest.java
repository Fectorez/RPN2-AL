...
public class CLITest {
    ...
    public void should_evaluate_swap() {
        assertThat(evaluate("6 4 SWAP -")).isEqualTo("-2.0");
    }

    @Test
    public void should_evaluate_sqrt() {
        assertThat(evaluate("25 SQRT")).isEqualTo("5.0");
    }

    @Test
    public void should_evaluate_drop() {
        assertThat(evaluate("2 7 DROP 3 +")).isEqualTo("5.0");
    }

    @Test
    public void should_evaluate_times() {
        assertThat(evaluate("2 5 TIMES")).isEqualTo("2.0 2.0 2.0 2.0 2.0");
    }
